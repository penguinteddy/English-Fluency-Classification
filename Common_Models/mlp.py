...
# Convert labels to categorical one-hot encoding
    y_train = keras.utils.to_categorical(y_train-1, num_classes= 2) # Convert class vector into binary Matrix
    print (y_train, y_train.shape, y_train.size)
    y_test = keras.utils.to_categorical(y_test-1, num_classes= 2)
    print (y_test, y_test.shape, y_test.size)
