...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun  3 13:25:42 2023
...
def save_mfcc(dataset_path, json_path, num_mfcc=25, n_fft=2048, hop_length=512, num_segments=1):
		...
		# load audio file
            for f in filenames:
                ...
                if len(mfcc) == num_mfcc_vectors_per_segment:
                    ...
                    if (semantic_label == "good"):
                        data["labels"].append(0)
                    else:
                        data["labels"].append(1)
                    print("{}, segment:".format(file_path))
